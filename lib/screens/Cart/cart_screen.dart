  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(child: Consumer<OrderProvider>(
      builder: (_,order,child)=>Scaffold(
        ...
        body:order.getList().length<=0? Container(
          width: size.width,
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: Text("When you add products to your order they'll show up here.",style: TextStyle(
                    color: Colors.black,
                    fontWeight: FontWeight.w500,
                    fontSize: size.width*0.05,height: 1.3
          ...
          child: ListView.builder(
              ...
              itemBuilder: (_, index) {
                totalPrice = double.parse(order.getList()[index]["price"]) + totalPrice;
                return Container(
                  width: size.width,
                    ...
                    children: [
                      Row(children: [
                        Container(
                          ...
                          child:
                          Image.asset("images/${order.getList()[index]["image"]}"),
                        ),
                        Column(
        ...
        bottomNavigationBar:order.getList().length<=0?Container(
          ...
          child: Column(
            children: [
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Container(
                        ...
                        child:Text("\$$totalPrice + Taxes & Fees",style: TextStyle(
              ...
              InkWell(
                ...
                child: Container(
                  margin: EdgeInsets.symmetric(horizontal: size.width*0.05,vertical: size.height*0.005),
                height: size.height*0.08,
                  width: size.width,
                  alignment: Alignment.center,
                  child: Text("Choose Delivery Window",style: TextStyle(
                    color: Colors.white,
