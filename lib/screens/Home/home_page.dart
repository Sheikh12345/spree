        ...
        bottomNavigationBar: Container(
          ...
          child: BottomNavigationBar(
            ...
            items: [
              ...
              BottomNavigationBarItem(icon: Icon(Icons.add_shopping_cart,color: _tabIndex==2?Colors.blue: Colors.black),title: Text("Cart",style: TextStyle(color: _tabIndex==2?Colors.blue: Colors.black))),
